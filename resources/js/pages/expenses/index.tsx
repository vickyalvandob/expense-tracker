...
import type { Expense, ExpenseCollection, BreadcrumbItem } from '@/types';
...
export default function Index({ collection }: Props) {
    ...
    const handleSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        if (data.id) {
            router.put(`/expenses/${data.id}`, data, options);
        } else {
            router.post('/expenses', data, options);
        }
    };
    ...
    const confirmDelete = () => {
        ...
        router.delete(`/expenses/${deleteItem.id}`, {
            onSuccess: () => {
                setDeleteOpen(false);
                setDeleteItem(null);
            },
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex items-center justify-between px-4 pt-4">
                <h1 className="text-xl font-semibold">Expense List</h1>
